...
// #define FONT3X5_FIRSTCHAR 0x20
// #define FONT3X5_CHARCNT 0x60 

// typedef struct __attribute__((packed)) {
//    uint16_t font_size_in_bytes;
//    uint8_t font_width;
//    uint8_t font_height;
//    uint8_t font_first_char;
//    uint8_t font_char_count;
//    uint8_t font_char_widths[FONT3X5_CHARCNT];
//    uint8_t font_data[];
// } Font;

#define FONT_SIZE_OFFSET 0
#define FONT_WIDTH_OFFSET 2
#define FONT_HEIGHT_OFFSET 3
#define FONT_FIRST_CHAR_OFFSET 4
#define FONT_CHAR_COUNT_OFFSET 5
#define FONT_CHAR_WIDTHS_OFFSET 6
